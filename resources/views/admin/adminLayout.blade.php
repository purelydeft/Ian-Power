                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-6" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('pages.new')}}">New Page</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('pages.pagelist')}}">Page Listing</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('faq.list')}}">Faq Listing</a>
                                        </li>
                                        <li class="nav-item">
