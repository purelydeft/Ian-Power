...
<div class="col-md-12">
    ...
    <form action="{{route('faq.update',$faq->id)}}" method="POST">
      ...
      <input type="text" class="form-control" id="faq_title" placeholder="Enter page title" name="faq_title" value="{{ $faq->faq_title}}">
        @error('faq_title')
...
@enderror
      ...
      <div class="form-group">
        ...
        <textarea name="faq_description" id="faq-desc">{{ $faq->faq_description}}</textarea>
