...
<div class="col-md-12">
  <div class="add-page-btn-wrap">
    ...
    <form action="{{ route('update-page',$page->slug) }}" method="post">
        @csrf
  ...
  @enderror
      ...
      <div class="form-group">
        ...
        <textarea name="description" id="page-desc">{{$page->description}}</textarea>
        @error('description')
        <div class="alert alert-danger">{{ $message }}</div>
    @enderror
      </div>
      <div class="form-group">
        ...
        <textarea name="description2" id="page-desc-2">{{$page->description2}}</textarea>
        @error('description')
        <div class="alert alert-danger">{{ $message }}</div>
    @enderror
      </div>
      <div class="form-group">
        ...
        <textarea name="description3" id="page-desc-3">{{$page->description3}}</textarea>
        @error('description')
        <div class="alert alert-danger">{{ $message }}</div>
    @enderror
      </div>
      <div class="form-group">
        ...
        <textarea name="description4" id="page-desc-4">{{$page->description4}}</textarea>
        @error('description')
        <div class="alert alert-danger">{{ $message }}</div>
    @enderror
      </div>
